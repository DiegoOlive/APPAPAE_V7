...
public class Cadastrar_Gastos extends javax.swing.JFrame {
    private boolean per;
    
    private OperacaoDoador opDoador;
    
    
    public Cadastrar_Gastos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/visao/imagens/logo_gastos.png"))); // NOI18N
    ...
    private void btCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCadastrarActionPerformed
       ...
       Date data = conv(this.txtData.getText());
       java.sql.Date data1;
       data1 = new java.sql.Date(data.getTime());
       Gasto custo = new Gasto(
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastrar_Gastos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cadastrar_Gastos().setVisible(true);
            }
        });
    }
