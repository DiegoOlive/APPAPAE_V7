...
public class Lista_Doadores extends javax.swing.JFrame {
    private boolean per;
    
    public Lista_Doadores() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/visao/imagens/logo_doadores.png"))); // NOI18N
    ...
    private void btRetornarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRetornarActionPerformed
        Operacao_Doador oD = new Operacao_Doador();
        oD.permissao(per);
        oD.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lista_Doadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lista_Doadores().setVisible(true);
            }
        });
    }
